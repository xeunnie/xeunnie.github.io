...
export const CAREERS: Career[] = [
  {
    ...
    summary:
      "골프장에서 매일 실사용되는 서비스의 제품 단위 책임자로 일하고 있습니다. GPS 좌표를 코스맵 픽셀로 변환하고, 움직이는 카트 위에서도 정확히 동작하는 터치 UX를 설계했으며, F&B 제품 전반과 React Native 앱을 스토어 제출까지 각각 단독으로 끝냈습니다. 브라우저 밖의 제약(사설망 프린터, 망분리 단말, 스토어 심사)까지 설계에 넣어야 했던 구간입니다.",
    details: [
  ...
  },
  {
    ...
    summary:
      "3D·지도 기반 관제 SI의 프론트엔드 책임자로 일했습니다. 그 전 1년간 부트캠프와 스터디에서 쌓은 것을 여기에 전부 쏟았습니다 — 폐쇄망 WebRTC CCTV를 현장에서 돌게 만들고, 프로젝트마다 복사되던 컴포넌트와 API 호출을 모노레포 패키지로 걷어냈습니다.",
    details: [
      ...
      "WebRTC CCTV — RTCPeerConnection recvonly 트랜시버로 게이트웨이와 SDP를 교환해 RTSP 카메라를 브라우저에서 재생, 현장 운영까지 도달",
  ...
  },
  {
    ...
    type: "full-time",
    chapter: "성장 — 공공기관 SI를 처음부터 끝까지",
    summary:
      "공공기관 SI를 성실하게 했습니다. 디자인 시안부터 반응형 퍼블리싱, PHP 연동까지 한 사람이 끝까지 끌고 가는 일이었고, 6개 기관 약 200페이지를 그렇게 넘겼습니다. 화려한 기술보다 마감과 접근성을 지키는 근육이 붙은 시기입니다.",
    details: [
  ...
  },
  {
    ...
    chapter: "시작 — 코드의 첫 현장",
    summary:
      "비개발 조직에서 유일한 개발 담당으로 일하며 자립적인 문제 해결 능력을 키웠습니다. 직접 디자인해 올린 팝업의 반응을 Google Analytics로 확인하면서, 코드가 사용자 행동을 바꿀 수 있다는 것을 처음 체감했습니다.",
    details: [
