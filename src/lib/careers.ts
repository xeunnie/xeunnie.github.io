...
export const CAREERS: Career[] = [
  {
    ...
    details: [
      ...
      "VGOLF F&B 제품 전반 단독 개발 (10개월 · 520커밋) — 주문·관리자·주방 영수증 출력·매장 사이니지 서브시스템을 설계·구현",
      ...
      "VGOLF 모바일 앱(React Native) 단독 개발 — 555커밋, FSD 5레이어 구조와 3겹 에러 안전망을 세우고 Expo 없이 네이티브 설정·릴리스 서명·Play Console 제출까지 수행",
