      ...
      <div className="mx-auto max-w-6xl px-6 text-center">
        ...
        >
          <a
            ...
            aria-label="이메일 보내기"
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-ice-500">
          ...
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="text-ice-500">
